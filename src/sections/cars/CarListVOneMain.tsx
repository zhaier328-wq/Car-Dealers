...
const CarListVOneMain: React.FC = () => {
    ...
    return (
        <section className="car-listing-page-one">
            <div className="container">
                <div className="row">
                    <div className="col-xl-9">
                        <div className="car-listing-page-one__left">
                            <div className="row">
                                {
                                    currentCars.map((item, i) => <div key={i} className="col-xl-4 col-lg-4 col-md-6">
                                        <div className="listing-one__single MX100">
                                            <div className="listing-one__img">
                                                {
                                                    item.image && (<Image src={item.image} width={280} height={171} alt="Image" />)
                                                }
...
export default CarListVOneMain;